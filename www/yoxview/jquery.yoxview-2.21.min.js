 ...
 */ (function (b) {
    function jb() {
        ...
        function Ua(a, c, e, f) {
            ...
            if (a[0].tagName == "A") a.bind("click.yoxview", h);
                ...
                onClick: f || function (g) {
                    g.preventDefault();
                    c.thumbnailsOptions && c.thumbnailsOptions.onClick ? c.thumbnailsOptions.onClick(b(g.currentTarget).data("yoxview").imageIndex, b(g.currentTarget), b(g.liveFired).data("yoxview").viewIndex) : b.yoxview.open(b(g.liveFired || g.currentTarget).data("yoxview").viewIndex, b(g.currentTarget).data("yoxview").imageIndex);
                    return false
                }
        ...
        function Sa() {
            ...
            else Yox.Support.rgba() && t.css("background-color", Yox.hex2rgba(d.backgroundColor, d.backgroundOpacity));
        ...
        function Ia() {
            if (d.cacheBuffer) {
                ...
                if (l.cacheBufferLastIndex < 0) l.cacheBufferLastIndex += m;
        ...
        function vb(a, c, e, f, h) {
            jQuery.jsonp({
                url: wb[a] || "http://oohembed.com/oohembed/",
                data: jQuery.extend({
                    url: c,
                    format: "json"
                }, e),
        ...
        this.init = function (a, c) {
            function e() {
                a.each(function (g, i) {
                    ...
                    if (f.allowedUrls) f.allowedImageUrls = f.allowedImageUrls.concat(f.allowedUrls);
        ...
        b(Oa).load(function () {
            this.width == 0 ? wa("Image error") : ta(b.extend({}, b.yoxview.currentImage.media, {
                width: this.width,
                height: this.height
            }))
        }).error(function () {
    ...
    b.fn.yoxview = function (H) {
        ...
        else typeof H === "object" || !H ? b.yoxview.init(this, H) : b.error("Method " + H + " does not exist on YoxView.");
        return this
    };
