...
class Obras_model extends CI_Model {
    ...
    */
    ...
    {
		$this->db->select("obra.id_obra, obra.nombre_obra, obra.info_tecnica, artista.id_artista, artista.nombre_artista, categoria_obra.id_categoria_obra, categoria_obra.nombre_categoria_obra, obra.destacada, obra.orden");
        $this->db->from('obra');
    ...
    */
    public function get_obras($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		...
		$this->db->select('obra.id_obra, obra.nombre_obra, obra.info_tecnica, artista.nombre_artista, categoria_obra.nombre_categoria_obra, destacada');
		$this->db->from('obra');
        $this->db->join('artista', 'artista.id_artista = obra.id_artista', 'inner');
        $this->db->join('categoria_obra', 'categoria_obra.id_categoria_obra = obra.id_categoria_obra', 'inner');
    ...
    public function get_obras_categoria($idCategoria, $order=null, $order_type='Asc'){
        $this->db->select('obra.id_obra, obra.nombre_obra, obra.info_tecnica, artista.nombre_artista, categoria_obra.nombre_categoria_obra');
        $this->db->from('obra');
        $this->db->join('artista', 'artista.id_artista = obra.id_artista', 'inner');
        $this->db->join('categoria_obra', 'categoria_obra.id_categoria_obra = obra.id_categoria_obra', 'inner');
    ...
    */
    ...
    function obtener_destacadas_ordenadas(){
        $this->db->select('obra.id_obra, obra.nombre_obra, obra.info_tecnica, artista.nombre_artista');
        $this->db->from('obra');
        $this->db->join('artista', 'artista.id_artista = obra.id_artista', 'inner');
