			...
			<div class="wrapper tabs">
				...
				<div class="col2 pad_left1 clearfix">
					<div class="tab-content" id="<?=$nombre_categoria_obra?>">
						...
						<figure class="left dis_imadet"><a href="<?=base_url();?>uploads/obras/<?=$obra['id_obra'];?>.gal.jpg" title="<?=$obra['nombre_obra']?> / <?=$obra['nombre_artista']?>" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img title="<?=$obra['nombre_obra']?> / <?=$obra['nombre_artista'] . '<br>' . nl2br($obra['info_tecnica'])?>" src="<?=base_url();?>uploads/obras/<?=$obra['id_obra'];?>.prv.jpg" alt=""></a></figure>
						<?php endforeach; ?>
						</div>
					</div>
				</div>
