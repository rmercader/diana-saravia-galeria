...
if ( ValidateModuleParameters($_GET['MOD'], 'aplicaciones') ){
	$Opc = $_GET['MOD'];
}

$file = 'aplicaciones/'.$Opc.'.php';
include($file);
...
// Menu Productos
$Menu->AddOpcion(1, 'Aplicaciones');
$Menu->AddOpcionLink(1, 1, 'Nueva Aplicacion', $mod_Script, array('MOD'=>'aplicaciones', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Aplicaciones',$mod_Script, array('MOD'=>'aplicaciones','PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('APLICACIONES', 'base_modulo.htm');
