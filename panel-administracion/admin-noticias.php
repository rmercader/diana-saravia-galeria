...
if ( ValidateModuleParameters($_GET['MOD'], 'noticias') ){
	$Opc = $_GET['MOD'];
}

$file = 'noticias/'.$Opc.'.php';
include($file);
...
// Menu Productos
$Menu->AddOpcion(1, 'Noticias');
$Menu->AddOpcionLink(1, 1, 'Nueva Noticia', $mod_Script, array('MOD'=>'noticias', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Noticias',$mod_Script, array('MOD'=>'noticias','PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('NOTICIAS', 'base_modulo.htm');
