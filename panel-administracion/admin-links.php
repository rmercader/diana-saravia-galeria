...
if ( ValidateModuleParameters($_GET['MOD'], 'links') ){
	$Opc = $_GET['MOD'];
}
...
// Menu Productos
$Menu->AddOpcion(1, 'Links');
$Menu->AddOpcionLink(1, 1, 'Nuevo Link', $mod_Script, array('MOD'=>'links', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Link',$mod_Script, array('MOD'=>'links','PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('LINKS DE INTERÉS', 'base_modulo.htm');
