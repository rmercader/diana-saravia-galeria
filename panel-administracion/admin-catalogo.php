...
// Menu Productos
$Menu->AddOpcion(1, 'Productos');
$Menu->AddOpcionLink(1, 1, 'Nuevo Producto', $mod_Script, array('MOD'=>'productos', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Productos',$mod_Script, array('MOD'=>'productos','PVEZ'=>_SI));
